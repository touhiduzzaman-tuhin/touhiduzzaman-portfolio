                ...
                <Navbar.Collapse id="basic-navbar-nav">
                   <h3 class='text-white'> TOUHIDUZZAMAN </h3>
                    ...
                    <Link style={{textDecoration:'none',color:`${window.location.pathname==='/contack-us' ? 'rgb(81, 233, 157)':'white'}`}} to={`/contact`}>
                          ...
                          <a href="https://drive.google.com/file/d/13v1O5gaVY9hk0PsTEA1tQZrsp5BQUuo3/view" target="_blank"><button class="btn btn-outline-success my-2 my-sm-0" type="submit">Resume.pdf</button> </a>
                    </Nav>
                </Navbar.Collapse>
            </Navbar>
        </div>
